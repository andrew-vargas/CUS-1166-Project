...
* Class: CloudController.java
* Author: Katherine Dumancela
* Due: October 25, 2022
* This class is used to create a functional registration page for new cloud controller 
* users and as well as create the Cloud Controller constructor.
*/
